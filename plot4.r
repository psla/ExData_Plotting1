...
# graph 2
plot(hpcFiltered$datetime, hpcFiltered$Voltage, type = "l", ylab = "Voltage")
...
# graph 4
plot(hpcFiltered$datetime, hpcFiltered$Global_reactive_power, type = "l", ylab = "Global_reactive_power")
